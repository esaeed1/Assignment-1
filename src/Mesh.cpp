...
Mesh::Mesh(const std::string &filename) : m_num_vertices(0), m_num_faces(0) {
    m_bmin = Eigen::Vector3f(std::numeric_limits<float>::max(), std::numeric_limits<float>::max(),
                             std::numeric_limits<float>::max());
    m_bmax = Eigen::Vector3f(-std::numeric_limits<float>::max(), -std::numeric_limits<float>::max(),
                             -std::numeric_limits<float>::max());
...
unsigned int Mesh::get_number_of_face() const { return m_num_faces; }

Eigen::Vector3f Mesh::get_mesh_center() { return m_mesh_center; }
...
float Mesh::get_dist_max() const { return m_dist_max; }